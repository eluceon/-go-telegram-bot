...
type UserServiceClient interface {
	...
	GetTopUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Users, error)
}
...
func (c *userServiceClient) GetTopUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Users, error) {
	out := new(Users)
	err := c.cc.Invoke(ctx, "/user.UserService/GetTopUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetTopUsers(context.Context, *Empty) (*Users, error)
...
func (UnimplementedUserServiceServer) ReadUser(context.Context, *ID) (*User, error) {
...
func (UnimplementedUserServiceServer) GetTopUsers(context.Context, *Empty) (*Users, error) {
...
func _UserService_GetTopUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetTopUsers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.UserService/GetTopUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetTopUsers(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_GetTopUsers_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/userpb/user.proto",
}
